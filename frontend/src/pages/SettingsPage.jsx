...
const ProfilePage = () => {
  ...
  if (user)
    return (
      <form onSubmit={handleSubmit(updateUser, displayErrors)}>
          ...
          <div className="mx-3 col">
            ...
            <div className="formGroup my-2">
              ...
              <Controller
                ...
                render={({ field }) => (
                  <ImageUpload
                    src={field.value} // form value → component
                    onUpload={(url) => field.onChange(url)} // component → form
                    onDelete={() => field.onChange("")} // clear value in form
                    width="150px"
                    height="150px"
                  />
                )}
